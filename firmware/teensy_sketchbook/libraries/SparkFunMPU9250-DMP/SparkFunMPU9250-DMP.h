...
{
	DMPASYNCSTATE_INIT,
	DMPASYNCSTATE_FIFOCOUNTH_START,
	DMPASYNCSTATE_FIFOCOUNTH_WAIT,
	DMPASYNCSTATE_FIFOCOUNTL_START,
	DMPASYNCSTATE_FIFOCOUNTL_WAIT,
	DMPASYNCSTATE_FIFORW_START,
	DMPASYNCSTATE_FIFORW_WAIT,
};
...
public:
	...
	// asyncStateMachine -- Uses DMA assisted SPI to perform non-blocking reads of the FIFO
	// Output: true if there is new data in the FIFO, false otherwise
	bool asyncStateMachine(void);
